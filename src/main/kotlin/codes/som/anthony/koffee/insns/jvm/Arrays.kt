...
val InstructionAssembly.iaload: U
    get() {
        instructions.add(InsnNode(IALOAD))
    }
val InstructionAssembly.laload: U
    get() {
        instructions.add(InsnNode(LALOAD))
    }
val InstructionAssembly.faload: U
    get() {
        instructions.add(InsnNode(FALOAD))
    }
val InstructionAssembly.daload: U
    get() {
        instructions.add(InsnNode(DALOAD))
    }
val InstructionAssembly.aaload: U
    get() {
        instructions.add(InsnNode(AALOAD))
    }
val InstructionAssembly.baload: U
    get() {
        instructions.add(InsnNode(BALOAD))
    }
val InstructionAssembly.caload: U
    get() {
        instructions.add(InsnNode(CALOAD))
    }
val InstructionAssembly.saload: U
    get() {
        instructions.add(InsnNode(SALOAD))
    }
val InstructionAssembly.iastore: U
    get() {
        instructions.add(InsnNode(IASTORE))
    }
val InstructionAssembly.lastore: U
    get() {
        instructions.add(InsnNode(LASTORE))
    }
val InstructionAssembly.fastore: U
    get() {
        instructions.add(InsnNode(FASTORE))
    }
val InstructionAssembly.dastore: U
    get() {
        instructions.add(InsnNode(DASTORE))
    }
val InstructionAssembly.aastore: U
    get() {
        instructions.add(InsnNode(AASTORE))
    }
val InstructionAssembly.bastore: U
    get() {
        instructions.add(InsnNode(BASTORE))
    }
val InstructionAssembly.castore: U
    get() {
        instructions.add(InsnNode(CASTORE))
    }
val InstructionAssembly.sastore: U
    get() {
        instructions.add(InsnNode(SASTORE))
    }
val InstructionAssembly.arraylength: U
    get() {

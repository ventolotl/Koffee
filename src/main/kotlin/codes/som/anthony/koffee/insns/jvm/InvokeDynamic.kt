...
fun InstructionAssembly.invokedynamic(
    name: String,
    returnType: TypeLike,
...
fun InstructionAssembly.h_invokevirtual(
    owner: TypeLike,
    name: String,
    descriptor: String,
...
fun InstructionAssembly.h_invokespecial(
    owner: TypeLike,
    name: String,
    descriptor: String,
    isInterface: Boolean = false
...
fun InstructionAssembly.h_invokeinterface(
    owner: TypeLike,
    name: String,
    descriptor: String,
    isInterface: Boolean = false
...
fun InstructionAssembly.h_invokestatic(
    owner: TypeLike,
    name: String,
    descriptor: String,
    isInterface: Boolean = false
